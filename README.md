...
Worldcoin is an experimental new digital currency that enables instant payments to
...
Run with the -testnet option to run with "play worldcoins" on the test network, if you
...
Worldcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
