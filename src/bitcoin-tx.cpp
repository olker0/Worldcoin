...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Worldcoin Core worldcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  worldcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded worldcoin transaction") + "\n" +
              "  worldcoin-tx [options] -create [commands]   " + _("Create hex-encoded worldcoin transaction") + "\n" +
              "\n";
