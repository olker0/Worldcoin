...
bool AppInit(int argc, char* argv[])
{
    ...
    {
        std::string strUsage = _("Worldcoin Core Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n";
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  worldcoind [options]                     " + _("Start Worldcoin Core Daemon") + "\n";
    ...
    try
    {
        ...
        if (fCommandLine)
        {
            fprintf(stderr, "Error: There is no RPC client functionality in worldcoind anymore. Use the worldcoin-cli utility instead.\n");
            exit(1);
        }
#ifndef WIN32
