...
const char* BIP71_MIMETYPE_PAYMENT = "application/worldcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/worldcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/worldcoin-paymentrequest";
