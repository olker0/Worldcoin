    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Worldcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Worldcoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Worldcoin Core is shutting down...") + "<br /><br />" +
