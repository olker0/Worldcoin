    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Worldcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Worldcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Worldcoin Core"));
    ...
    openAction->setStatusTip(tr("Open a worldcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Worldcoin Core help message to get a list with possible Worldcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Worldcoin Core client") + " " + networkStyle->getTitleAddText();
